// Professional Chat Widget - Supabase Powered with Enhanced UI
(function () {
    'use strict';
    ...
    function getBotId() {
        ...
        for (let script of scripts) {
            ...
            if (src && src.includes('chat-widget-supabase.js')) {
    ...
    // Run: node generate-config.js to regenerate config from .env
    ...
    function setupEventListeners(container) {
        ...
        // Start conversation
        newChatBtn.addEventListener('click', () => startNewConversation(chatContainer, chatInterface, messagesContainer));
    ...
    async function typeMessage(message, messageElement) {
        if (!config.ui.enableTypingAnimation) {
    ...
    async function startNewConversation(chatContainer, chatInterface, messagesContainer) {
        // Generate session ID for future messages
        currentSessionId = generateUUID();
        console.log('🚀 New conversation started with sessionId:', currentSessionId);
        ...
        // Display welcome message from Supabase config
        const botMessageDiv = document.createElement('div');
        botMessageDiv.className = 'chat-message bot';
        messagesContainer.appendChild(botMessageDiv);

        // Use welcome text from Supabase configuration
        const welcomeMessage = config.branding.welcomeText || 'Hello! How can I help you today?';
        console.log('💬 Displaying welcome message from Supabase:', welcomeMessage);
    ...
    async function sendMessage(message, messagesContainer) {
        ...
        try {
            ...
            console.log('📊 Message limit result:', limitResult);
            ...
            if (limitResult.remaining !== undefined) {
                console.log(`✅ Message allowed. ${limitResult.remaining} remaining this month.`);
            }
        } catch (limitError) {
        ...
        try {
            ...
            setTimeout(() => {
                ...
                if (!botResponse) {
                    console.error('❌ No bot response found in:', data);
